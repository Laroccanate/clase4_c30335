...
let paseoViernes = parseFloat(prompt("¿Cuants metroso camino el dia Viernes?"))
let paseoSabado = parseFloat(prompt("¿Cuanto camino el dia Sabado?"))
let paseoDomingo =  prompt(nombre + ", ¿pasea los dias Domingo?").toLowerCase()
let domSi = ""
let suma = ""
...
let iva1 = prompt("Quiere sacar el calculo con el iva del 21%?")
